...
#include "../../baoshimizhen/registerwindow.h"
...
QT_MOC_LITERAL(4, 49, 23) // "on_pushButton_2_clicked"
    ...
    "RegisterWindow\0sendsignal\0\0"
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWindow::sendsignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::sendsignal()
{
