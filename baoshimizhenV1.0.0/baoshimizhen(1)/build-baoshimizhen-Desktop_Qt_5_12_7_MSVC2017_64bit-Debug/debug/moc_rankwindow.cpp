...
#include "../../baoshimizhen/rankwindow.h"
...
QT_MOC_LITERAL(3, 23, 21) // "on_pushButton_clicked"
    ...
    "RankWindow\0sendsignal\0\0on_pushButton_clicked"
};
...
void RankWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RankWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RankWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RankWindow::sendsignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RankWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_RankWindow.data,
    qt_meta_data_RankWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
